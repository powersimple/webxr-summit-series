...
<a-asset-item id="The4thPolysLogo" response-type="arraybuffer" src="/assets/models/polys/4th/ThePolys-4thAnnualWebXRAwards-logo.glb"></a-asset-item>
<a-asset-item id="The5thPolysLogo" response-type="arraybuffer" src="/assets/models/polys/5th/ThePolys-5thAnnualWebXRAwards-logo.glb"></a-asset-item>
...
<?php
 $trophy = '2023-Hosts-Trophy';//default
 if(@$_GET['trophy']){
     $trophy = @$_GET['trophy'];
 }
?>
