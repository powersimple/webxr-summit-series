...
<!-- <a-entity id="Polys2-logo-model" class="center-obj-zone" static-body
                        ...
                        <a-light id="green1" type="point" intensity="1" position="1 1 1" rotation="0 0 0" angle="90"></a-light>
<a-light id="red1" type="point" color="#900" color="#090" intensity="1" position="-1 -1 -1" rotation="0 0 0" angle="90"></a-light>
<a-light id="blue1" type="point" color="#009" intensity="1" position="-1 -1 -1" rotation="0 0 0" angle="90"></a-light>
                    </a-entity>
  ...
  <?php
    ...
    <a-entity id="credits" position="0 0 20" rotation="0 0 0">
        <?php

//   include "webxr/polys2/pedestals.php";
 include "webxr/polys2/credits.php";
